...
job "nostr-rs-relay" {
  ...
  group "app" {
    ...
    service {
      ...
      tags = [
        "traefik.enable=true",
	    "traefik.http.routers.nostr-relay.tls=true",
        "traefik.http.routers.nostr-relay.entrypoints=http,https,http-public,https-public",
        "traefik.http.routers.nostr-relay.rule=( Host(`nostr-relay.philipcristiano.com`))",
	    "traefik.http.routers.nostr-relay.tls.certresolver=home",
      ]
    ...
    task "app" {
      ...
      config {
        ...
        mount = {
          type     = "bind"
          source   = "local/nostr-rs-relay.toml"
      ...
      template {
          destination = "local/nostr-rs-relay.toml"
          data = <<EOF
...
name = "nostr-relay-philipcristiano"

# Description
description = "Personal relay for philipcristiano"
...
domain_whitelist = ["philipcristiano.com"]
