  ...
  group "cache" {
    ...
    task "redis" {
      ...
      service {
        ...
        tags = [
          "traefik.enable=true",
          "traefik.tcp.routers.baserow-redis.entrypoints=baserow-redis",
          "traefik.tcp.routers.baserow-redis.rule=HostSNI(`*`)",
        ]
...
masteruser default
requirepass {{ key "credentials/baserow-redis/password" }}
